...
var rules_onDecode         = function(decode) {
	...
	if (regexProbeEtiketten.test(decode.data)) {
		...
		decode.data = cc_ctrlF10 + "Org KWIA BarcodeScanner" + cc_enter + "<sleep rep=1>" + d[0] + cc_tab + cc_tab + d[1] + cc_tab + cc_enter + "<sleep rep=1>" + cc_ctrlF10 + cc_del;
	}

	if (regexAuftrag.test(decode.data)) {
		var d = decode.data.split('_');
		decode.data = cc_ctrlF10 + "Org KWIA BarcodeScanner" + cc_enter + "<sleep rep=1>" + cc_tab + d[1] + cc_tab + cc_tab + cc_enter + "<sleep rep=1>" + cc_ctrlF10 + cc_del;
	}
